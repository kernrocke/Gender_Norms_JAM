...
**  DO-FILE METADATA
    ...
    // 	date last modified      10-MAY-2026
...
** School
gen school_type = . 
replace school_type = 1 if schid <=12
replace school_type = 2 if schid >=13 & schid!=.

label define school_type 1"Primary" 2"Secondary High School"
